 ...
 * @package NetworkIt
 */
class networkitConnectorRequest extends modConnectorResponse {

    function __construct(networkit &$networkit,array $config = array()) {
        parent::__construct($networkit->modx,$config);
    ...
    public function handle($action = '') {
        ...
        $path = $this->networkit->config['processorsPath'].strtolower($action).'.php';
